...
#bar chart on games by viewer count
...
y_upper = [i + (i*0.15) for i in viewers_hour] #create error shade
y_lower = [i - (i*0.15) for i in viewers_hour] #create error shade
plt.fill_between(hour, y_lower, y_upper, alpha=0.2) #create error shade
plt.show()
plt.clf()
